...
urlpatterns = patterns('',
    ...
    url(r'^expense_update/(?P<pk>.*)$', ExpenseUpdate.as_view(), name='expense_update'),
    url(r'^expense_delete/(?P<pk>.*)$', ExpenseDelete.as_view(), name='expense_delete'),     
    ...
    url(r'^expense_category_update/(?P<pk>\d+)/$', ExpenseCategoryUpdate.as_view(), name='expense_category_update'),
    url(r'^expense_category_delete/(?P<pk>\d+)/$', ExpenseCategoryDelete.as_view(), name='expense_category_delete'),
